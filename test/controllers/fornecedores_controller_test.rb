...
class FornecedoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fornecedor" do
    assert_difference('Fornecedor.count') do
      post fornecedores_url, params: { fornecedor: { cnpj: @fornecedor.cnpj, codigo: @fornecedor.codigo, razaoSocial: @fornecedor.razaoSocial } }
    end
  ...
  test "should update fornecedor" do
    patch fornecedor_url(@fornecedor), params: { fornecedor: { cnpj: @fornecedor.cnpj, codigo: @fornecedor.codigo, razaoSocial: @fornecedor.razaoSocial } }
